...
import { Zap, Shield, Thermometer, Battery, Ship, MapPin, Activity, FileText, ChevronRight, Flame, Eye, BarChart3, Gauge, Home } from 'lucide-react';
      ...
      <header className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="max-w-6xl mx-auto">
          <nav className="flex items-center gap-1.5 text-sm mb-3">
            ...
            <ChevronRight className="w-3 h-3 text-gray-300" />
            <span className="text-gray-700 font-medium">Lithium-Sentinel AI</span>
          </nav>
