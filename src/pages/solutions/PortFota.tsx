...
import { BarChart3, Shield, Download, AlertTriangle, CheckCircle, Activity, Sparkles, Clock, Server, Layers, ChevronRight, Radio, Home } from 'lucide-react';
      ...
      <header className="bg-white border-b border-gray-200 pt-20 pb-4">
        <div className="max-w-6xl mx-auto px-6">
          <nav className="flex items-center gap-1.5 text-sm mb-3">
            ...
            <ChevronRight className="w-3 h-3 text-gray-300" />
            <span className="text-gray-700 font-medium">Port-FOTA Hub</span>
          </nav>
