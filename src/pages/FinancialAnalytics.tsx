...
const reports = getReportsByDomain('financial')
const meta = domainMeta.financial
...
export default function FinancialAnalytics() {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <TabNavigation activeDomain="financial" />

      {/* Page Header */}
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-3">
          <div className="w-12 h-12 rounded-xl bg-fs-income/10 flex items-center justify-center">
            <DollarSign size={22} className="text-fs-income" />
          </div>
          <div>
